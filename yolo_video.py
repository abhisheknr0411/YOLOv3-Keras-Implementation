...
if __name__ == '__main__':
    ...
    '''
    parser.add_argument(
        "--input", nargs='?', type=str,required=False,default='/content/gdrive/My Drive/VID-20200220-WA0004.mp4',
        help = "Video input path"
    )

    parser.add_argument(
        "--output", nargs='?', type=str, default="/content/gdrive/My Drive/project_folder/car.mp4",
